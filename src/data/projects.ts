...
export const projects: Project[] = [
  ...
  },
  {
    id: 'lingua-ai',
    name: 'LinguaAI',
    description: 'Real-time voice and text translation app supporting 100+ languages using OpenAI Whisper for speech recognition and LibreTranslate for translation. Features one-click recording, conversation mode, text-to-speech, translation history, and zero API cost.',
    tech: ['Next.js 14', 'FastAPI', 'OpenAI Whisper', 'LibreTranslate', 'WebSocket', 'SQLite', 'TypeScript'],
    link: 'https://amrit-lingua-ai.vercel.app',
    github: 'https://github.com/D3stroy3rX9/lingua-ai',
    status: 'live',
  },
  {
  ...
  },
  {
    ...
    description: 'ML-powered tournament prediction model for FIFA World Cup 2026. Predicts match outcomes and simulates the full bracket using historical data, ELO ratings, and team form metrics.',
    tech: ['Python', 'scikit-learn', 'Pandas', 'NumPy', 'Vercel'],
    link: 'https://amrit-wc26predictor.vercel.app',
    github: 'https://github.com/D3stroy3rX9/worldcup2026-predictor',
    status: 'live',
  },
  {
    id: 'portfolio',
